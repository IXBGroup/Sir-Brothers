...
export const metadata: Metadata = {
  ...
  openGraph: { title: "SIR Brothers LLC | Tree Removal & Property Cleanup", description: "Hardworking local tree removal and property cleanup across Central Nebraska.", type: "website", images: [{url:"/og.png",width:1200,height:630,alt:"SIR Brothers LLC tree removal and property cleanup"}] },
  twitter: { card: "summary_large_image", title: "SIR Brothers LLC", description: "Tree removal and property cleanup done right in Central Nebraska.", images: ["/og.png"] },
  icons: { icon: "/favicon.svg", shortcut: "/favicon.svg" },
};

const schema = { "@context":"https://schema.org", "@type":"LocalBusiness", name:"SIR Brothers LLC", image:"/og.png", telephone:"+1-308-440-3207", email:"sirbrothersllc@gmail.com", address:{"@type":"PostalAddress",addressLocality:"Broken Bow",addressRegion:"NE",postalCode:"68822",addressCountry:"US"}, areaServed:["Broken Bow","Custer County","Kearney","North Platte","Grand Island","Central Nebraska"], serviceType:["Tree Removal","Stump Removal","Stump Grinding","Cedar Tree Removal","Storm Cleanup","Skid Steer Work","Property Cleanup","Brush Clearing","Hauling","Snow Removal"] };
