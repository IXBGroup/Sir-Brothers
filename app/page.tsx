  ...
  return (
    <main>
      ...
      <section className="contact" id="contact">
        <div className="contact-intro"><p className="eyebrow"><span /> FREE ESTIMATES</p><h2>LET’S TALK<br /><em>ABOUT THE JOB.</em></h2><p>Share a few details and we’ll follow up about your tree removal, cleanup or equipment work.</p><a className="phone-big" href="tel:+13084403207"><small>CALL DIRECT</small>308-440-3207</a><a className="contact-email" href="mailto:sirbrothersllc@gmail.com">sirbrothersllc@gmail.com</a><div className="social-links" aria-label="Find S.I.R Brothers LLC online"><a className="facebook" href="https://www.facebook.com/SIRBrothersLLC" target="_blank" rel="noopener noreferrer"><b><img src="/facebook.svg" alt="" /></b><span>Facebook</span></a><a className="instagram" href="https://www.instagram.com/s.i.r.brothers/" target="_blank" rel="noopener noreferrer"><b><img src="/instagram.svg" alt="" /></b><span>Instagram</span></a><a className="google" href="https://share.google/v4ysNRUhPK3Wgt2Ms" target="_blank" rel="noopener noreferrer"><b><img src="/google-business.svg" alt="" /></b><span>Google Business</span></a></div></div>
